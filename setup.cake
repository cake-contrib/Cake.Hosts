...
BuildParameters.SetParameters(context: Context, 
                            ...
                            title: "Cake.Hosts",
                            solutionFilePath: "./src/Cake.Hosts.sln",
...
ToolSettings.SetToolSettings(context: Context,
                            dupFinderExcludePattern: new string[] { 
                                BuildParameters.RootDirectoryPath + "/src/Cake.Hosts.Tests/*.cs",
                                BuildParameters.RootDirectoryPath + "/src/Cake.Hosts/*Aliases.cs" },
